...
Essa aula será dividida em 3 partes. Na primeira, vamos fazer uma breve revisão de algumas funções. Na segunda, vamos abordar o conceito de limite e na terceira o de derivada, que é conceito mais importante o nosso propósito, ou seja, _machine learning_. Novamente, isso é uma aula de revisão. Para saber mais recorra as referências fornecidas.

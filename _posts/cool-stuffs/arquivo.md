...
author: lucastassis
excerpt: "Visualizações dos arremessos de quadra do Toronto Raptors nas Temporadas de 2019-20 e 2020-21. As visualizações buscam dar um entendimento de como um time que terminou a temporada 2019-20 com 53-19 caiu para 27-45 na temporada 2020-21."
toc: true
categories:
  - CoolStuffs
tags:
...
| <img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/roster_scatter.png" style="zoom:12.5%;" /><img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/roster_scatter.png" style="zoom:12.5%;" /> |      |
| ------------------------------------------------------------ | ---- |
...
<img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/roster_freq_per_feet.png" style="zoom: 20%;" />

<img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/roster_freq_per_feet.png" style="zoom:20%;" />
...
<img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/roster_fg_per_feet.png" style="zoom:20%;" />

<img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/roster_fg_per_feet.png" style="zoom:20%;" />
...
| <img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/fredvanvleet.png" style="zoom:12.5%;" /><img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/fredvanvleet.png" style="zoom:12.5%;" /> |      |
| ------------------------------------------------------------ | ---- |
...
<img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/fredvanvleet_fg_per_feet.png" style="zoom: 20%;" />

<img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/fredvanvleet_fg_per_feet.png" style="zoom: 20%;" />
...
| <img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/kylelowry.png" style="zoom: 12.5%;" /><img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/kylelowry.png" style="zoom: 12.5%;" /> |      |
| ------------------------------------------------------------ | ---- |
...
| <img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/pascalsiakam.png" style="zoom: 12.5%;" /><img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/pascalsiakam.png" style="zoom: 12.5%;" /> |      |
| ------------------------------------------------------------ | ---- |
...
| <img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2019-20/oganunoby.png" style="zoom: 12.5%;" /><img src="{{ site.url }}{{ site.baseurl }}/assets/img/posts/raps-shotcharts-imgs/2020-21/oganunoby.png" style="zoom: 12.5%;" /> |      |
| ------------------------------------------------------------ | ---- |
